...
public class NetworkManager {
    ...
    public static void init(final FMLCommonSetupEvent event) {
        ...
        registerMessage(MultiMidiNotePacket.class, MultiMidiNotePacket::encodePacket, MultiMidiNotePacket::decodePacket, createHandler(MidiNotePacketHandler::handlePacketClient, MidiNotePacketHandler::handlePacketServer));
    }
