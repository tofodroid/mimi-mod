...
public abstract class EntityUtils {
    ...
    public static BlockPos getEntityHeadPos(LivingEntity entity) {
        return BlockPos.containing(new Vec3(entity.getX(), entity.isPassenger() ? (entity.getVehicle().getPassengersRidingOffset() + entity.getEyeY()) : entity.getEyeY(), entity.getZ()));
    }
}
