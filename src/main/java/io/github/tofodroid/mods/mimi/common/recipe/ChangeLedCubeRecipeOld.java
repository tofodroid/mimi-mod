...
public class ChangeLedCubeRecipeOld extends CustomRecipe {
    public static final String REGISTRY_NAME = "changeledcube";

	public static final SimpleCraftingRecipeSerializer<?> SERIALIZER = new SimpleCraftingRecipeSerializer<ChangeLedCubeRecipeOld>(ChangeLedCubeRecipeOld::new);

    public ChangeLedCubeRecipeOld(ResourceLocation recipeId, CraftingBookCategory category) {
