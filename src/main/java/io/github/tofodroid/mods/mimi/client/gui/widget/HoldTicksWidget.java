...
public class HoldTicksWidget extends BaseWidget {
    ...
    public void renderText(PoseStack graphics, Font font, Integer mouseX, Integer mouseY) {
        ...
        Screen.drawString(graphics, font, MidiNbtDataUtils.getHoldTicks(midiStack).toString(), ABSOLUTE_START.x() + VALUE_TEXT_COORDS.x, ABSOLUTE_START.y() + VALUE_TEXT_COORDS.y, 0xFF00E600);
    }
