...
public class BlockAdvListener extends AContainerBlock<TileAdvListener> {
    private static final IntegerProperty POWER = BlockStateProperties.POWER_0_15;

    public BlockAdvListener() {
        ...
        this.setRegistryName("advlistener");
    }

    @Override
    public TileEntityType<TileAdvListener> getTileType() {
        return ModTiles.ADVLISTENER;
    }
