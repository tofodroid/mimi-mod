...
public class ClientProxy implements Proxy {
    ...
    protected static void registerBlockColors(ColorHandlerEvent.Block event, List<? extends Block> blocks) {
        event.getBlockColors().register((state, reader, pos, color) -> {
            return reader != null && pos != null && reader.getTileEntity(pos) != null && reader.getTileEntity(pos) instanceof TileInstrument ? 
                ((TileInstrument)reader.getTileEntity(pos)).getColor() : -1;
