...
public class EntitySeat extends Entity {
    ...
    public void tick() {
        ...
        if(!this.level().isClientSide) {
            ...
            if(source == null || this.getPassengers().isEmpty() || blockEntity == null || !(blockEntity instanceof TileInstrument) || this.getPassengers().stream().allMatch(e -> !e.isAddedToLevel() || !e.isAlive() || !(e instanceof Player))) {
                this.discard();
            }
        }
